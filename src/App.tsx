  ...
  const listaDeSkins = [
    {
      ...
      price: 750,
      image: shacoringa,
      history: 'No sombrio submundo de Runeterra, onde a loucura e o caos se encontram, nasceu Shacoringa, uma figura enigmática cuja risada perturbadora ecoa pelas sombras. Outrora um mero truqueiro, Shaco encontrou um artefato arcano que fundiu sua essência com a do infame palhaço do terror, Coringa. Transformado, ele agora vagueia pelas ruelas de Zaun, seu rosto deformado em um eterno sorriso sinistro, brincando cruelmente com suas vítimas antes de desaparecer sem deixar rastro. A cada aparição, Shacoringa espalha o medo e a incerteza, deixando uma trilha de cartas ensanguentadas e um aviso claro: a loucura é sua maior arma.'
    },
    {
      id: 2,
